  ...
  actions: [
    {
      ...
      run: ["if",
        ...
        ["array",
          ["call", "setKind", "context", "ash"],
          ["call", "removeField", "context", "flammable"],
        ],
        null,
      ],
    },
    {
      ...
      run: ["if",
        ...
        ["array",
          ["call", "setKind", "context", "steam"],
          ["call", "removeCard", "target"],
        ],
        null,
      ],
    },
    {
      ...
      run: ["if",
        ...
        ["array",
          ["call", "setKind", "context", "mud"],
          ["call", "removeField", "context", "hard"],
          ["call", "removeCard", "target"],
        ],
        null,
      ],
    ...
    },
    {
      ...
      run: ["if",
        ...
        ["array",
          ["call", "removeField", "context", "flammable"],
          ["call", "setField", "context", "wet", true],
          ["call", "setText", "context", ["__lit", "Wet Wood"]],
        ],
        null,
      ],
    },
    {
      ...
      run: ["if",
        ...
        ["array",
          ["call", "setKind", "context", "stone"],
          ["call", "removeField", "context", "wet"],
        ],
        null,
      ],
    },
    ...
    },
    {
      ...
      run: ["if",
        ...
        ["array",
          ["call", "setKind", "context", "stone"],
          ["call", "removeField", "context", "sharp"],
          ["call", "removeCard", "target"],
        ],
        null,
      ],
